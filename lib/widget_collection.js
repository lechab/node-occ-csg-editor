...
class WidgetCollection extends WidgetCollectionBase {
    ...
    checkReplaceItem(oldWidgetLike, newWidget, errorList) {
        ...
        for (let i = 0; i < connectors.length; i++) {
            ...
            const indexInPossibleAncestor = (!!connector.get().origin)?( possibleAncestors.findIndex(my_filter) || possibleAncestors.findIndex(my_filter_import)): possibleAncestors.findIndex(my_filter);
