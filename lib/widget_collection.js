    ...
    checkReplaceItem(oldWidgetLike, newWidget, errorList) {
        ...
        for (let i = 0; i < connectors.length; i++) {
            ...
            const my_filter_import = (e) => ((e.name === connector.get().name)
                && (e.origin.libGUID === connector.get().origin.libGUID));
            ...
            const indexInPossibleAncestor = possibleAncestors.findIndex(my_filter) || possibleAncestors.findIndex(my_filter_import);
