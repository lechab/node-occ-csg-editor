...
class GeomPrimitive extends GeomBase {
    ...
    evaluateParameters(parameters){
        ...
        this.innerTranslation.vector.set(evaluateExpressionPoint(this.innerTranslation.vector, parameters));

        this.innerRotation.center.set(evaluateExpressionPoint(this.innerRotation.axis, parameters));
        this.innerRotation.axis.set(evaluateExpressionPoint(this.innerRotation.axis, parameters));
        this.innerRotation.angle.set(evaluateExpressionPoint(this.innerRotation.angle, parameters));
...
class GeomPrimitiveBox extends GeomPrimitive {
    ...
    evaluateParameters(parameters){
        super.evaluateParameters(parameters);
        this.point1.set(evaluateExpressionPoint(this.point1, parameters));
        this.point2.set(evaluateExpressionPoint(this.point1, parameters));
    }
...
class GeomPrimitiveSphere extends GeomPrimitive {
    ...
    evaluateParameters(parameters){
        super.evaluateParameters(parameters);
        this.center.set(evaluateExpressionPoint(this.center, parameters));
        this.radius.set(evaluateExpression(this.radius, parameters));
    }
...
class GeomPrimitiveTorus extends GeomPrimitive {
    ...
    evaluateParameters(parameters){
        super.evaluateParameters(parameters);
        this.center.set(evaluateExpressionPoint(this.center, parameters));
        this.axis.set(evaluateExpressionPoint(this.axis, parameters));
