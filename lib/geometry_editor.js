...
class GeomPrimitiveBox extends GeomPrimitive {
    ...
    toVoluPrimitive(isNested = false) {
...
class GeomOperation extends GeomBase {
    ...
    toVoluPrimitive(isNested = true) {
        ...
        return "csg.makeVoluOperation("
            + "\"" + this.name + "\"" + ","
            + "\"" + operationName + "\"" + ","
            + "\"" + this.leftArg.get().toFullScript(true) + "\"" + ","
            + "\"(" + this.rightArg.get().toFullScript(true) + ")"
            + this.innerTransformationsString(true) + "\")";
    }
...
class GeomTransfo extends GeomBase {
    ...
    toVoluPrimitive(isNested = true) {
        ...
        return "csg.makeVoluTransfo("
            ...
            + "\"" + transfoType + "\"" + ","
            + transfoDef + "," +
            "\"(" + this.geometry.get().toFullScript(true) + ")"
            + this.innerTransformationsString(true) + "\")";
    }
