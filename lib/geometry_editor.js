...
class GeomBase extends WidgetBase {
    ...
    innerTransformationsString(isNested = false) {
        ...
        const isThereAnyTranslation = (
            (this.innerTranslation.vector.X.exp !== "0" && parseFloat(this.innerTranslation.vector.X.exp !== 0)) ||
            (this.innerTranslation.vector.Y.exp !== "0" && parseFloat(this.innerTranslation.vector.Y.exp !== 0)) ||
            (this.innerTranslation.vector.Z.exp !== "0" && parseFloat(this.innerTranslation.vector.Z.exp !== 0))
        );
