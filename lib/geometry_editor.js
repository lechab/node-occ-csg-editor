...
class GeomOperationCutCylinder extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        this.overridExpSet(this.leftArg.get().radius);
...
class GeomOperationCutCone extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        this.overridExpSet(this.leftArg.get().radius1);
        this.overridExpSet(this.leftArg.get().radius2);
...
class GeomOperationCutTorus extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        // Override setter to trigger reresh on rgithArg depending on thickness value
        this.overridExpSet(this.leftArg.get().center.X);
        this.overridExpSet(this.leftArg.get().center.Y);
        this.overridExpSet(this.leftArg.get().center.Z);


        this.overridExpSet(this.leftArg.get().mainRadius);
        this.overridExpSet(this.leftArg.get().smallRadius);
