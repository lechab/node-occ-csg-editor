...
class Expression {
    constructor(exp) {
        this.exp = exp || "0"; // cos($myParam)*$myParam2/$total
    }
...
class GeomOperationCutPrimitive extends GeomBase {
    ...
    constructor(name, arg1, arg2) {
        ...
        this.leftArg = {
            geom : null,
            set: function(geom) {
                self.leftArg.geom = geom;
            },
            get: function() {
                return self.leftArg.geom;
            }
        };
        this.leftArg.set(arg1);
        this.rightArg = {
            geom : null,
            set: function(geom) {
                self.rightArg.geom = geom;
            },
            get: function() {
                return self.rightArg.geom;
            }
        };
        this.rightArg.set(arg2);

        this.thickness = new Expression();

        this.thickness.set(0);

        this.thickness.set = function (exp) {

            self.thickness.exp = exp;
            self.refreshRightArg();
...
class GeomOperationCutBox extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        this.overridExpSet(this.leftArg.get().point1.X);
        this.overridExpSet(this.leftArg.get().point1.Y);
        this.overridExpSet(this.leftArg.get().point1.Z);

        this.overridExpSet(this.leftArg.get().point2.X);
        this.overridExpSet(this.leftArg.get().point2.Y);
        this.overridExpSet(this.leftArg.get().point2.Z);
    }
...
class GeomOperationCutCylinder extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        // Override setter to trigger reresh on rgithArg depending on thickness value
        overridExpSet(this.leftArg.get().point1.X);
        overridExpSet(this.leftArg.get().point1.Y);
        overridExpSet(this.leftArg.get().point1.Z);

        overridExpSet(this.leftArg.get().point2.X);
        overridExpSet(this.leftArg.get().point2.Y);
        overridExpSet(this.leftArg.get().point2.Z);

        overridExpSet(this.leftArg.get().radius);
...
class GeomOperationCutCone extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        overridExpSet(this.leftArg.get().radius1);
        overridExpSet(this.leftArg.get().radius2);
    ...
    refreshRightArg() {
        ...
        this.rightArg.get().radius1.set(this.leftArg.get().radius1.exp + "-" + this.thickness.exp);
        this.rightArg.get().radius2.set(this.leftArg.get().radius2.exp + "-" + this.thickness.exp);
...
class GeomOperationCutTorus extends GeomOperationCutPrimitive {
    ...
    constructor(name) {
        ...
        // Override setter to trigger reresh on rgithArg depending on thickness value
        overridExpSet(this.leftArg.get().center.X);
        overridExpSet(this.leftArg.get().center.Y);
        overridExpSet(this.leftArg.get().center.Z);


        overridExpSet(this.leftArg.get().mainRadius);
        overridExpSet(this.leftArg.get().smallRadius);
    ...
    refreshRightArg() {
        ...
        this.rightArg.get().mainRadius.set(this.leftArg.get().mainRadius.exp + "+" + this.thickness.exp);
