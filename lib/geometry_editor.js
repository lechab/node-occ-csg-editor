...
class GeomPrimitive extends GeomBase {
    ...
    evaluateParameters(parameters){
        ...
        this.innerRotation.center.set(evaluateExpression(this.innerRotation.axis, parameters));
        this.innerRotation.axis.set(evaluateExpression(this.innerRotation.axis, parameters));
        this.innerRotation.angle.set(evaluateExpression(this.innerRotation.angle, parameters));
