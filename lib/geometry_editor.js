...
function redefineNestedFuse(str, itNumber, nameOfShape, shapeNewDefinition) {
    ...
    assert(shapeNewDefinition.name.indexOf(nameOfShape) > -1,
        "expecting the name of the newShape " +
...
const WidgetConnector = require("node-occ-csg-editor/lib/widget_connector").WidgetConnector;
const WidgetBase = require("node-occ-csg-editor/lib/widget_base").WidgetBase;
const WidgetCollection = require("node-occ-csg-editor/lib/widget_collection").WidgetCollection;
const WidgetBaseConn = require("node-occ-csg-editor/lib/widget_base_conn").WidgetBaseConn;
const WidgetConnectorList = require("node-occ-csg-editor/lib/widget_connector_list").WidgetConnectorList;
...
class GeomTransfoTranslate extends GeomTransfo {
    ...
    constructor(name) {
        ...
        this.times.set(1);
        this.redefinitionStatus = "REDEFINE";
    }
